...
<div id="popap">
	...
	<a href="<?php print(GAME_URL); ?>synonym_03.php" id="next_but">NEXT</a>
	<div id="backrefresh"><a id="back" href="<?php print(GAME_URL); ?>"></a><a id="refresh" href="<?php print(GAME_URL); ?>synonym_02.php"></a></div>
</div>
</div><!-- end container -->
...
<?php require_once '../footer.php'; ?>
	...
	function addnum(){
		...
		if (num == 8) {setInterval(function(){document.getElementById("popap").style.visibility = "visible"},1000); localStorage.setItem('synonym', 2);};
	}
